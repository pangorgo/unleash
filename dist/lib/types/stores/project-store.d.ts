import { IEnvironmentProjectLink, IProjectMembersCount } from '../../db/project-store';
import { IEnvironment, IProject, IProjectWithCount, ProjectMode } from '../model';
...
export declare type ProjectEnvironment = {
    environment: string;
