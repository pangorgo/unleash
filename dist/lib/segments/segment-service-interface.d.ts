...
export interface ISegmentService {
    ...
    create(data: UpsertSegmentSchema, user: Partial<Pick<IUser, 'username' | 'email'>>): Promise<ISegment>;
    update(id: number, data: UpsertSegmentSchema, user: Partial<Pick<IUser, 'username' | 'email'>>): Promise<void>;
    unprotectedUpdate(id: number, data: UpsertSegmentSchema, user: Partial<Pick<IUser, 'username' | 'email'>>): Promise<void>;
