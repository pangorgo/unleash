...
const OPENAPI_TAGS = [
    ...
    { name: 'Auth', description: 'Manage logins, passwords, etc.' },
    {
        ...
        description: 'Operations related to [Change Requests](https://docs.getunleash.io/reference/change-requests).',
    },
    {
        name: 'Client',
    ...
    {
        name: 'Notifications',
        description: 'Manage [notifications](https://docs.getunleash.io/reference/notifications).',
    },
    {
        name: 'Operational',
