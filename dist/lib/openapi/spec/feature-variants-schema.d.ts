...
export declare const featureVariantsSchema: {
    ...
    readonly description: "A versioned collection of feature toggle variants.";
    readonly properties: {
        readonly version: {
        ...
        readonly variants: {
            ...
            readonly description: "All variants defined for a specific feature toggle.";
        };
    };
    readonly components: {
        readonly schemas: {
...
export declare type FeatureVariantsSchema = FromSchema<typeof featureVariantsSchema>;
