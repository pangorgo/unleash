...
exports.featureTypesSchema = void 0;
const feature_type_schema_1 = require("./feature-type-schema");
exports.featureTypesSchema = {
    $id: '#/components/schemas/featureTypesSchema',
    type: 'object',
    additionalProperties: false,
    description: 'A list of [feature toggle types](https://docs.getunleash.io/reference/feature-toggle-types) and the schema version used to represent those feature types.',
    ...
    properties: {
        version: {
            ...
            enum: [1],
            example: 1,
            description: 'The schema version used to describe the feature toggle types listed in the `types` property.',
        },
        types: {
            type: 'array',
