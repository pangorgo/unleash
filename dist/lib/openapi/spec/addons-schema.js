...
2. A list of all addon providers defined on this instance`,
    ...
    components: {
        schemas: {
            addonSchema: addon_schema_1.addonSchema,
            addonTypeSchema: addon_type_schema_1.addonTypeSchema,
