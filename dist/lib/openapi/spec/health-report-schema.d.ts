...
export declare const healthReportSchema: {
    ...
    readonly description: "A report of the current health of the requested project, with datapoints like counters of currently active, stale, and potentially stale feature toggles.";
    readonly required: readonly ["version", "name", "defaultStickiness", "mode", "members", "health", "environments", "features", "potentiallyStaleCount", "activeCount", "staleCount"];
    readonly properties: {
        readonly potentiallyStaleCount: {
            readonly type: "number";
            readonly description: "The number of potentially stale feature toggles.";
            readonly example: 5;
        };
        readonly activeCount: {
            readonly type: "number";
            readonly description: "The number of active feature toggles.";
            readonly example: 2;
        };
        readonly staleCount: {
            readonly type: "number";
            readonly description: "The number of stale feature toggles.";
            readonly example: 10;
        };
        readonly version: {
        ...
        readonly health: {
            readonly type: "integer";
            readonly description: "The overall [health rating](https://docs.getunleash.io/reference/technical-debt#health-rating) of the project.";
            readonly example: 95;
        };
...
export declare type HealthReportSchema = FromSchema<typeof healthReportSchema>;
