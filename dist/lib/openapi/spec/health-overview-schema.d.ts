...
export declare const healthOverviewSchema: {
    ...
    readonly required: readonly ["version", "name", "defaultStickiness", "mode", "members", "health", "environments", "features"];
...
export declare type HealthOverviewSchema = FromSchema<typeof healthOverviewSchema>;
